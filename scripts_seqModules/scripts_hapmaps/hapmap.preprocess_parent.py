...
###
### If (runMode == "hapmap")
###     Process the 'putative_SNPs_v4.txt' data for a project to generate a list of het-loci for child
###     strains to be compared against in the hapmap.
###	    Output : $hapmapDirectory"SNPdata_parent.temp.txt"
###     (The only difference is in the location of output and log file notes.)
### else if (runMode == "LOH")
###     Process the 'putative_SNPs_v4.txt' data for a project to generate a list of het-loci for child
###     strains to be compared to against a parent project.
###     (The only difference is in the location of output and log file notes.)
###     Output : $projectDirectory"SNPdata_parent.temp.txt";
### end;
...
with open(logName, "a") as myfile:
	...
	myfile.write("\t\t*--------------------------------------------------------------------------*\n")
	myfile.write("\t\t| End of 'scripts_seqModules/scripts_hapmaps/hapmap.preprocess_parent.py'  |\n")
	myfile.write("\t\t*==========================================================================*\n")
