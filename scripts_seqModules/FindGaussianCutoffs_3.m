...
elseif (copyNum == 1)
	...
	for i = 1:(copyNum+1); G{i}.d = skew_factor; end;
	...
	% Construct curve
	fit_curve_1 = G{1}.a*exp(-0.5*((range-G{1}.b)./G{1}.c).^2)                            + G{1}.a*exp(-0.5*((range-G{1}.b)./G{1}.c/(skew_factor/G{1}.b)).^2);
	fit_curve_2 = G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c/(skew_factor/(200-G{2}.b))).^2) + G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c).^2);
...
elseif (copyNum == 2)
	...
	fit_curve_3 = G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c/(skew_factor/(200-G{3}.b))).^2) + G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c).^2);
	plot(fit_curve_1,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_2,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
...
elseif (copyNum == 3)
	...
	% Construct curve
	fit_curve_1 = G{1}.a*exp(-0.5*((range-G{1}.b)./G{1}.c).^2)                            + G{1}.a*exp(-0.5*((range-G{1}.b)./G{1}.c/(skew_factor/G{1}.b)).^2);
	fit_curve_2 = G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c).^2)                            + G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c/(skew_factor/G{2}.b)).^2);
	fit_curve_3 = G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c/(skew_factor/(200-G{3}.b))).^2) + G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c).^2);
	fit_curve_4 = G{4}.a*exp(-0.5*((range-G{4}.b)./G{4}.c/(skew_factor/(200-G{4}.b))).^2) + G{4}.a*exp(-0.5*((range-G{4}.b)./G{4}.c).^2);
	plot(fit_curve_1,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_2,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_3,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
...
elseif (copyNum == 4)
	...
	fit_curve_4 = G{4}.a*exp(-0.5*((range-G{4}.b)./G{4}.c/(skew_factor/(200-G{4}.b))).^2) + G{4}.a*exp(-0.5*((range-G{4}.b)./G{4}.c).^2);
	fit_curve_5 = G{5}.a*exp(-0.5*((range-G{5}.b)./G{5}.c/(skew_factor/(200-G{5}.b))).^2) + G{5}.a*exp(-0.5*((range-G{5}.b)./G{5}.c).^2);
	plot(fit_curve_1,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_2,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_3,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_4,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
...
elseif (copyNum == 5)
	...
	fit_curve_1 = G{1}.a*exp(-0.5*((range-G{1}.b)./G{1}.c).^2)                            + G{1}.a*exp(-0.5*((range-G{1}.b)./G{1}.c/(skew_factor/G{1}.b)).^2);
	fit_curve_2 = G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c).^2)                            + G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c/(skew_factor/G{2}.b)).^2);
	fit_curve_3 = G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c).^2)                            + G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c/(skew_factor/G{3}.b)).^2);
	fit_curve_4 = G{4}.a*exp(-0.5*((range-G{4}.b)./G{4}.c/(skew_factor/(200-G{4}.b))).^2) + G{4}.a*exp(-0.5*((range-G{4}.b)./G{4}.c).^2);
	fit_curve_5 = G{5}.a*exp(-0.5*((range-G{5}.b)./G{5}.c/(skew_factor/(200-G{5}.b))).^2) + G{5}.a*exp(-0.5*((range-G{5}.b)./G{5}.c).^2);
	fit_curve_6 = G{6}.a*exp(-0.5*((range-G{6}.b)./G{6}.c/(skew_factor/(200-G{6}.b))).^2) + G{6}.a*exp(-0.5*((range-G{6}.b)./G{6}.c).^2);
	plot(fit_curve_1,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_2,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_3,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_4,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
...
elseif (copyNum == 6)
	...
	fit_curve_5 = G{5}.a*exp(-0.5*((range-G{5}.b)./G{5}.c/(skew_factor/(200-G{5}.b))).^2) + G{5}.a*exp(-0.5*((range-G{5}.b)./G{5}.c).^2);
	fit_curve_6 = G{6}.a*exp(-0.5*((range-G{6}.b)./G{6}.c/(skew_factor/(200-G{6}.b))).^2) + G{6}.a*exp(-0.5*((range-G{6}.b)./G{6}.c).^2);
	fit_curve_7 = G{7}.a*exp(-0.5*((range-G{7}.b)./G{7}.c/(skew_factor/(200-G{7}.b))).^2) + G{7}.a*exp(-0.5*((range-G{7}.b)./G{7}.c).^2);
	plot(fit_curve_1,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_2,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_3,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_4,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
...
elseif (copyNum == 7)
	...
	fit_curve_2 = G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c).^2)                            + G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c/(skew_factor/G{2}.b)).^2);
	fit_curve_3 = G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c).^2)                            + G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c/(skew_factor/G{3}.b)).^2);
	fit_curve_4 = G{4}.a*exp(-0.5*((range-G{4}.b)./G{4}.c).^2)                            + G{3}.a*exp(-0.5*((range-G{4}.b)./G{4}.c/(skew_factor/G{4}.b)).^2);
	fit_curve_5 = G{5}.a*exp(-0.5*((range-G{5}.b)./G{5}.c/(skew_factor/(200-G{5}.b))).^2) + G{4}.a*exp(-0.5*((range-G{5}.b)./G{5}.c).^2);
	fit_curve_6 = G{6}.a*exp(-0.5*((range-G{6}.b)./G{6}.c/(skew_factor/(200-G{6}.b))).^2) + G{4}.a*exp(-0.5*((range-G{6}.b)./G{6}.c).^2);
	fit_curve_7 = G{7}.a*exp(-0.5*((range-G{7}.b)./G{7}.c/(skew_factor/(200-G{7}.b))).^2) + G{5}.a*exp(-0.5*((range-G{7}.b)./G{7}.c).^2);
	fit_curve_8 = G{8}.a*exp(-0.5*((range-G{8}.b)./G{8}.c/(skew_factor/(200-G{8}.b))).^2) + G{6}.a*exp(-0.5*((range-G{8}.b)./G{8}.c).^2);
	plot(fit_curve_1,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_2,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_3,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_4,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
...
elseif (copyNum == 8)
	...
	fit_curve_2 = G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c).^2)                            + G{2}.a*exp(-0.5*((range-G{2}.b)./G{2}.c/(skew_factor/G{2}.b)).^2);
	fit_curve_3 = G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c).^2)                            + G{3}.a*exp(-0.5*((range-G{3}.b)./G{3}.c/(skew_factor/G{3}.b)).^2);
	fit_curve_4 = G{4}.a*exp(-0.5*((range-G{4}.b)./G{4}.c).^2)                            + G{4}.a*exp(-0.5*((range-G{4}.b)./G{4}.c/(skew_factor/G{4}.b)).^2);
	fit_curve_5 = G{5}.a*exp(-0.5*((range-G{5}.b)./G{5}.c).^2);
	fit_curve_6 = G{6}.a*exp(-0.5*((range-G{6}.b)./G{6}.c/(skew_factor/(200-G{6}.b))).^2) + G{6}.a*exp(-0.5*((range-G{6}.b)./G{6}.c).^2);
	fit_curve_7 = G{7}.a*exp(-0.5*((range-G{7}.b)./G{7}.c/(skew_factor/(200-G{7}.b))).^2) + G{7}.a*exp(-0.5*((range-G{7}.b)./G{7}.c).^2);
	fit_curve_8 = G{8}.a*exp(-0.5*((range-G{8}.b)./G{8}.c/(skew_factor/(200-G{8}.b))).^2) + G{8}.a*exp(-0.5*((range-G{8}.b)./G{8}.c).^2);
	fit_curve_9 = G{9}.a*exp(-0.5*((range-G{9}.b)./G{9}.c/(skew_factor/(200-G{9}.b))).^2) + G{9}.a*exp(-0.5*((range-G{9}.b)./G{9}.c).^2);
	plot(fit_curve_1,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_2,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_3,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_4,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	...
	G                   = [];
	[G{1}.a,G{1}.b,G{1}.c, G{2}.a,G{2}.b,G{2}.c, G{3}.a,G{3}.b,G{3}.c, G{4}.a,G{4}.b,G{4}.c, G{5}.a,G{5}.b,G{5}.c, G{6}.a,G{6}.b,G{6}.c, G{7}.a,G{7}.b,G{7}.c, G{8}.a,G{8}.b,G{8}.c, G{9}.a,G{9}.b,G{9}.c, G{10}.a,G{10}.b,G{10}.c, skew_factor] = ...
	...
	fit_curve_3  = G{ 3}.a*exp(-0.5*((range-G{3}.b)./G{ 3}.c).^2)                             + G{ 3}.a*exp(-0.5*((range-G{ 3}.b)./G{ 3}.c/(skew_factor/G{3}.b)).^2);
	fit_curve_4  = G{ 4}.a*exp(-0.5*((range-G{4}.b)./G{ 4}.c).^2)                             + G{ 4}.a*exp(-0.5*((range-G{ 4}.b)./G{ 4}.c/(skew_factor/G{4}.b)).^2);
	fit_curve_5  = G{ 5}.a*exp(-0.5*((range-G{4}.b)./G{ 5}.c).^2)                             + G{ 5}.a*exp(-0.5*((range-G{ 5}.b)./G{ 5}.c/(skew_factor/G{5}.b)).^2);
	fit_curve_6  = G{ 6}.a*exp(-0.5*((range-G{6}.b)./G{ 6}.c/(skew_factor/(200-G{ 6}.b))).^2) + G{ 6}.a*exp(-0.5*((range-G{ 6}.b)./G{ 6}.c).^2);
	fit_curve_7  = G{ 7}.a*exp(-0.5*((range-G{6}.b)./G{ 7}.c/(skew_factor/(200-G{ 7}.b))).^2) + G{ 7}.a*exp(-0.5*((range-G{ 7}.b)./G{ 7}.c).^2);
	fit_curve_8  = G{ 8}.a*exp(-0.5*((range-G{7}.b)./G{ 8}.c/(skew_factor/(200-G{ 8}.b))).^2) + G{ 8}.a*exp(-0.5*((range-G{ 8}.b)./G{ 8}.c).^2);
	fit_curve_9  = G{ 9}.a*exp(-0.5*((range-G{8}.b)./G{ 9}.c/(skew_factor/(200-G{ 9}.b))).^2) + G{ 9}.a*exp(-0.5*((range-G{ 9}.b)./G{ 9}.c).^2);
	fit_curve_10 = G{10}.a*exp(-0.5*((range-G{9}.b)./G{10}.c/(skew_factor/(200-G{10}.b))).^2) + G{10}.a*exp(-0.5*((range-G{10}.b)./G{10}.c).^2);
	plot(fit_curve_1,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_2,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_3,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
	plot(fit_curve_4,'color',[1.00 0.50 0.50],'linestyle','-','linewidth',1);
...
if (MakeFigure == true)
	...
	title(['allelic_ratios.chr_' num2str(chromosome) '.segment_' num2str(segment)],'HorizontalAlign','center','VerticalAlign','middle');
	hold off;
	xlim([1,200]);
