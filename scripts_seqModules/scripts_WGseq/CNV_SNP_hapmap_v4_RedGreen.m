...
AnglePlot                   = true;   % Show histogram of alleleic fraction at the left end of standard figure chromosomes.
	FillColors              = true;   %     Fill histogram using color
...
%% Hapmap figure already generated (by CNV_SNP_hapmap_v4.m), so exit now.
if (useHapmap == true)
	exit;
end;
...
if (useHapmap == true)
	...
	if (strcmp(project,hapmap) == 1)
		...
		homolog_a_color       = [1.0     0.0     0.0    ]; % homozygous A, phased.
		homolog_b_color       = [1.0     0.0     0.0    ]; % homozygous B, phased.
		het_color             = [0.66667 0.66667 0.66667]; % heterozygous.
