function [] = CNV_SNP_hapmap_v4_oldview(main_dir,user,genomeUser,project,hapmap,genome,ploidyEstimateString,ploidyBaseString, ...
...
%% Hapmap figure already generated, so exit now.
if (useHapmap == true)
	exit;
end;
...
% unphased colors.
	...
	unphased_color_2of3 = oddhet_unphased_color; % hom_unphased_color*2/3 + het_unphased_color*1/3;
	% tetraploid colors.
	unphased_color_4of4 = hom_unphased_color;
	unphased_color_3of4 = oddhet_unphased_color; % hom_unphased_color*3/4 + het_unphased_color*1/4;
	unphased_color_2of4 = het_unphased_color;
	% pentaploid colors.
	unphased_color_5of5 = hom_unphased_color;
	unphased_color_4of5 = oddhet_unphased_color; % hom_unphased_color*4/5 + het_unphased_color*1/5;
	unphased_color_3of5 = oddhet_unphased_color; % hom_unphased_color*3/5 + het_unphased_color*2/5;
	% hexaploid colors.
	unphased_color_6of6 = hom_unphased_color;
	unphased_color_5of6 = oddhet_unphased_color; % hom_unphased_color*5/6 + het_unphased_color*1/6;
	unphased_color_4of6 = oddhet_unphased_color; % hom_unphased_color*4/6 + het_unphased_color*2/6;
	unphased_color_3of6 = het_unphased_color;
	% heptaploid colors.
	unphased_color_7of7 = hom_unphased_color;
	unphased_color_6of7 = oddhet_unphased_color; % hom_unphased_color*6/7 + het_unphased_color*1/7;
	unphased_color_5of7 = oddhet_unphased_color; % hom_unphased_color*5/7 + het_unphased_color*2/7;
	unphased_color_4of7 = oddhet_unphased_color; % hom_unphased_color*4/7 + het_unphased_color*3/7;
	% octaploid colors.
	unphased_color_8of8 = hom_unphased_color;
	unphased_color_7of8 = oddhet_unphased_color; % hom_unphased_color*7/8 + het_unphased_color*1/8;
	unphased_color_6of8 = oddhet_unphased_color; % hom_unphased_color*6/8 + het_unphased_color*2/8;
	unphased_color_5of8 = oddhet_unphased_color; % hom_unphased_color*5/8 + het_unphased_color*3/8;
	unphased_color_4of8 = het_unphased_color;
	% nonaploid colors.
	unphased_color_9of9 = hom_unphased_color;
	unphased_color_8of9 = oddhet_unphased_color; % hom_unphased_color*8/9 + het_unphased_color*1/9;
	unphased_color_7of9 = oddhet_unphased_color; % hom_unphased_color*7/9 + het_unphased_color*2/9;
	unphased_color_6of9 = oddhet_unphased_color; % hom_unphased_color*6/9 + het_unphased_color*3/9;
	unphased_color_5of9 = oddhet_unphased_color; % hom_unphased_color*5/9 + het_unphased_color*4/9;
...
saveas(fig,        [projectDir 'fig.CNV-SNP-map.old1.eps'], 'epsc');
saveas(fig,        [projectDir 'fig.CNV-SNP-map.old1.png'], 'png' );
set(   Linear_fig, 'PaperPosition',[0 0 8 0.62222222]*2);
saveas(Linear_fig, [projectDir 'fig.CNV-SNP-map.old2.eps'], 'epsc');
saveas(Linear_fig, [projectDir 'fig.CNV-SNP-map.old2.png'], 'png' );
