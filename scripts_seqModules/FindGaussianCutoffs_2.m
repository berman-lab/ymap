...
if (length(smoothed) > 1)
	if (chrCopyNum{chromosome}(segment) <= 1.5)
		...
		if (MakeFigure == true)
			...
			fit_curve_1 = [G{1}.a*exp(-0.5*((time1_1-G{1}.b)./G{1}.c).^2)                            G{1}.a*exp(-0.5*((time1_2-G{1}.b)./G{1}.c/(skew_factor/G{1}.b)).^2)];
			fit_curve_2 = [G{2}.a*exp(-0.5*((time2_1-G{2}.b)./G{2}.c/(skew_factor/(200-G{2}.b))).^2) G{2}.a*exp(-0.5*((time2_2-G{2}.b)./G{2}.c).^2)                     ];
	...
	elseif (chrCopyNum{chromosome}(segment) <= 2.5)
		...
		if (MakeFigure == true)
			...
			fit_curve_3 = [G{3}.a*exp(-0.5*((time3_1-G{3}.b)./G{3}.c/(skew_factor/(200-G{3}.b))).^2) G{3}.a*exp(-0.5*((time3_2-G{3}.b)./G{3}.c).^2)                     ];
	...
	elseif (chrCopyNum{chromosome}(segment) <= 3.5)
		...
		if (G{2}.b+G{2}.c*OverlapLimit > G{3}.b-G{3}.c*OverlapLimit)   % recalculate as if disomy.
			...
			if (MakeFigure == true)
				...
				fit_curve_1 = [G{1}.a*exp(-0.5*((time1_1-G{1}.b)./G{1}.c).^2)                            G{1}.a*exp(-0.5*((time1_2-G{1}.b)./G{1}.c/(skew_factor/G{1}.b)).^2)];
				fit_curve_2 = [G{2}.a*exp(-0.5*((time2_1-G{2}.b)./G{2}.c).^2)                            G{2}.a*exp(-0.5*((time2_2-G{2}.b)./G{2}.c/(skew_factor/G{2}.b)).^2)];
				fit_curve_3 = [G{3}.a*exp(-0.5*((time3_1-G{3}.b)./G{3}.c/(skew_factor/(200-G{3}.b))).^2) G{3}.a*exp(-0.5*((time3_2-G{3}.b)./G{3}.c).^2)                     ];
				fit_curve_4 = [G{4}.a*exp(-0.5*((time4_1-G{4}.b)./G{4}.c/(skew_factor/(200-G{4}.b))).^2) G{4}.a*exp(-0.5*((time4_2-G{4}.b)./G{4}.c).^2)                     ];
	...
	elseif (chrCopyNum{chromosome}(segment) <= 4.5)
		...
		if (G{3}.b+G{3}.c*OverlapLimit > G{4}.b-G{4}.c*OverlapLimit)   % recalculate as if trisomy.
			...
			if (MakeFigure == true)
				...
				fit_curve_4 = [G{4}.a*exp(-0.5*((time4_1-G{4}.b)./G{4}.c/(skew_factor/(200-G{4}.b))).^2) G{4}.a*exp(-0.5*((time4_2-G{4}.b)./G{4}.c).^2)                     ];
				fit_curve_5 = [G{5}.a*exp(-0.5*((time5_1-G{5}.b)./G{5}.c/(skew_factor/(200-G{5}.b))).^2) G{5}.a*exp(-0.5*((time5_2-G{5}.b)./G{5}.c).^2)                     ];
	...
	elseif (chrCopyNum{chromosome}(segment) <= 5.5)
		...
		if (G{3}.b+G{3}.c*OverlapLimit > G{4}.b-G{4}.c*OverlapLimit)   % recalculate as if tetrasomy.
			...
			if (MakeFigure == true)
				...
				fit_curve_1 = [G{1}.a*exp(-0.5*((time1_1-G{1}.b)./G{1}.c).^2)                            G{1}.a*exp(-0.5*((time1_2-G{1}.b)./G{1}.c/(skew_factor/G{1}.b)).^2)];
				fit_curve_2 = [G{2}.a*exp(-0.5*((time2_1-G{2}.b)./G{2}.c).^2)                            G{2}.a*exp(-0.5*((time2_2-G{2}.b)./G{2}.c/(skew_factor/G{2}.b)).^2)];
				fit_curve_3 = [G{3}.a*exp(-0.5*((time3_1-G{3}.b)./G{3}.c).^2)                            G{3}.a*exp(-0.5*((time3_2-G{3}.b)./G{3}.c/(skew_factor/G{3}.b)).^2)];
				fit_curve_4 = [G{4}.a*exp(-0.5*((time4_1-G{4}.b)./G{4}.c/(skew_factor/(200-G{4}.b))).^2) G{4}.a*exp(-0.5*((time4_2-G{4}.b)./G{4}.c).^2)                     ];
				fit_curve_5 = [G{5}.a*exp(-0.5*((time5_1-G{5}.b)./G{5}.c/(skew_factor/(200-G{5}.b))).^2) G{5}.a*exp(-0.5*((time5_2-G{5}.b)./G{5}.c).^2)                     ];
				fit_curve_6 = [G{6}.a*exp(-0.5*((time6_1-G{6}.b)./G{6}.c/(skew_factor/(200-G{6}.b))).^2) G{6}.a*exp(-0.5*((time6_2-G{6}.b)./G{6}.c).^2)                     ];
		...
		if (G{4}.b+G{4}.c*OverlapLimit > G{5}.b-G{5}.c*OverlapLimit)   % recalculate as if pentasomy.
			...
			if (MakeFigure == true)
				...
				fit_curve_5 = [G{5}.a*exp(-0.5*((time5_1-G{5}.b)./G{5}.c/(skew_factor/(200-G{5}.b))).^2) G{5}.a*exp(-0.5*((time5_2-G{5}.b)./G{5}.c).^2)                     ];
				fit_curve_6 = [G{6}.a*exp(-0.5*((time6_1-G{6}.b)./G{6}.c/(skew_factor/(200-G{6}.b))).^2) G{6}.a*exp(-0.5*((time6_2-G{6}.b)./G{6}.c).^2)                     ];
				fit_curve_7 = [G{7}.a*exp(-0.5*((time7_1-G{7}.b)./G{7}.c/(skew_factor/(200-G{7}.b))).^2) G{7}.a*exp(-0.5*((time7_2-G{7}.b)./G{7}.c).^2)                     ];
