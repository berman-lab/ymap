function [p1_a,p1_b,p1_c, p2_a,p2_b,p2_c, p3_a,p3_b,p3_c, p4_a,p4_b,p4_c, p5_a,p5_b,p5_c, skew_factor] = ...
	fit_Gaussian_model_tetrasomy_2(data,locations,init_width,func_type)
    ...
    initial = [p1_ai,p1_ci,p2_ai,p2_ci,p3_ai,p3_ci,p4_ai,p4_ci,p5_ai,p5_ci, skew_factor,skew_factor,skew_factor,skew_factor,skew_factor];
	...
	skew_factor3 = abs(Estimates(13));
	skew_factor4 = abs(Estimates(14));
	skew_factor5 = abs(Estimates(15));
...
function sse = fiterror(params,time,data,func_type,locations,show)
	...
	skew_factor2 = abs(params(11));
	skew_factor3 = 1;
	skew_factor4 = abs(params(11));
	skew_factor5 = abs(params(11));
