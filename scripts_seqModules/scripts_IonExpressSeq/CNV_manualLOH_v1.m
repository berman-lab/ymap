		...
		if (chr_in_use(chr) == 1)
			...
			switch ploidyBase
				case 1
					...
					set(gca,'YTickLabel',{'','',''});
					text(-50000/bases_per_bin/2, maxY/2,     '1','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY,       '2','HorizontalAlignment','right','Fontsize',10);
				case 2
					set(gca,'YTick',[0 maxY/4 maxY/2 maxY/4*3 maxY]);
					set(gca,'YTickLabel',{'','','','',''});
					text(-50000/bases_per_bin/2, maxY/4,     '1','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/4*2,   '2','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/4*3,   '3','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY,       '4','HorizontalAlignment','right','Fontsize',10);
				case 3
					set(gca,'YTick',[0 maxY/6 maxY/3 maxY/2 maxY/3*2 maxY/6*5 maxY]);
					set(gca,'YTickLabel',{'','','','','','',''});
					text(-50000/bases_per_bin/2, maxY/6*3,   '3','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY,       '6','HorizontalAlignment','right','Fontsize',10);
				case 4
					set(gca,'YTick',[0 maxY/8 maxY/8*2 maxY/8*3 maxY/8*4 maxY/8*5 maxY/8*6 maxY/8*7 maxY]);
					set(gca,'YTickLabel',{'','','','','','','','',''});
					text(-50000/bases_per_bin/2, maxY/8*2,   '2','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/8*4,   '4','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/8*6,   '6','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY,       '8','HorizontalAlignment','right','Fontsize',10);
				case 5
					set(gca,'YTick',[0 maxY/10 maxY/10*2 maxY/10*3 maxY/10*4 maxY/10*5 maxY/10*6 maxY/10*7 ...
					                 maxY/10*8 maxY/10*9 maxY]);
					set(gca,'YTickLabel',{'','','','','','','','','','',''});
					text(-50000/bases_per_bin/2, maxY/10*2,  '2','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/10*5,  '5','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/10*7,  '7','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY,       '10','HorizontalAlignment','right','Fontsize',10);
				case 6
					...
					set(gca,'YTickLabel',{'','','','','','','','','','','','',''});
					text(-50000/bases_per_bin/2, maxY/12*2,  '2','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/12*6,  '6','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/12*10, '10','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY,       '12','HorizontalAlignment','right','Fontsize',10);
					case 7
					...
					set(gca,'YTickLabel',{'','','','','','','','','','','','','','',''});
					text(-50000/bases_per_bin/2, maxY/14*4,  '4','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/14*7,  '7','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/14*11, '11','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY,       '14','HorizontalAlignment','right','Fontsize',10);
				case 8
					...
					set(gca,'YTickLabel',{'','','','','','','','','','','','','','','','',''});
					text(-50000/bases_per_bin/2, maxY/16*4,  '4' ,'HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/16*8,  '8' ,'HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin/2, maxY/16*12, '12','HorizontalAlignment','right','Fontsize',10);
					text(-50000/bases_per_bin, maxY,       '16','HorizontalAlignment','right','Fontsize',10);
			end;
			set(gca,'FontSize',12);
		    ...
		    if (Linear_display == true)
				...
				if (first_chr)
					...
					case 1
						set(gca,'YTick',[0 maxY/2 maxY]);
						set(gca,'YTickLabel',{'','',''});
						text(-50000/bases_per_bin, maxY/2,     '1','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY,       '2','HorizontalAlignment','right','Fontsize',10);
					case 2
						set(gca,'YTick',[0 maxY/4 maxY/2 maxY/4*3 maxY]);
						set(gca,'YTickLabel',{'','','','',''});
						text(-50000/bases_per_bin, maxY/4,     '1','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/4*2,   '2','HorizontalAlignment','right','Fontsize',10);
					...
					case 3
						set(gca,'YTick',[0 maxY/6 maxY/3 maxY/2 maxY/3*2 maxY/6*5 maxY]);
						set(gca,'YTickLabel',{'','','','','','',''});
						text(-50000/bases_per_bin, maxY/6*3,   '3','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY,       '6','HorizontalAlignment','right','Fontsize',10);
					case 4
						set(gca,'YTick',[0 maxY/8 maxY/8*2 maxY/8*3 maxY/8*4 maxY/8*5 maxY/8*6 maxY/8*7 maxY]);
						set(gca,'YTickLabel',{'','','','','','','','',''});
						text(-50000/bases_per_bin, maxY/8*2,   '2','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/8*4,   '4','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/8*6,   '6','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY,       '8','HorizontalAlignment','right','Fontsize',10);
					case 5
						set(gca,'YTick',[0 maxY/10 maxY/10*2 maxY/10*3 maxY/10*4 maxY/10*5 maxY/10*6 maxY/10*7 ...
						                 maxY/10*8 maxY/10*9 maxY]);
						set(gca,'YTickLabel',{'','','','','','','','','','',''});
						text(-50000/bases_per_bin, maxY/10*2,  '2','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/10*5,  '5','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/10*7,  '7','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY,       '10','HorizontalAlignment','right','Fontsize',10);
					case 6
						set(gca,'YTick',[0 maxY/12 maxY/12*2 maxY/12*3 maxY/12*4 maxY/12*5 maxY/12*6 maxY/12*7 ...
						                 maxY/12*8 maxY/12*9 maxY/12*10 maxY/12*11 maxY]);
						set(gca,'YTickLabel',{'','','','','','','','','','','','',''});
						text(-50000/bases_per_bin, maxY/12*2,  '2','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/12*6,  '6','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/12*10, '10','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY,       '12','HorizontalAlignment','right','Fontsize',10);
					case 7
						set(gca,'YTick',[0 maxY/14 maxY/14*2 maxY/14*3 maxY/14*4 maxY/14*5 maxY/14*6 maxY/14*7 ...
						                 maxY/14*8 maxY/14*9 maxY/14*10 maxY/14*11 maxY/14*12 maxY/14*13 maxY]);
						set(gca,'YTickLabel',{'','','','','','','','','','','','','','',''});
						text(-50000/bases_per_bin, maxY/14*4,  '4','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/14*7,  '7','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/14*11, '11','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY,       '14','HorizontalAlignment','right','Fontsize',10);
					case 8
						set(gca,'YTick',[0 maxY/16 maxY/16*2 maxY/16*3 maxY/16*4 maxY/16*5 maxY/16*6 maxY/16*7 ...
						                 maxY/16*8 maxY/16*9 maxY/16*10 maxY/16*11 maxY/16*12 maxY/16*13 maxY/16*14 maxY/16*15 maxY]);
						set(gca,'YTickLabel',{'','','','','','','','','','','','','','','','',''});
						text(-50000/bases_per_bin, maxY/16*4,  '4' ,'HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/16*8,  '8' ,'HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY/16*12, '12','HorizontalAlignment','right','Fontsize',10);
						text(-50000/bases_per_bin, maxY,       '16','HorizontalAlignment','right','Fontsize',10);
	                end;
				else
					set(gca,'YTick',[]);
