function [p1_a,p1_b,p1_c, p2_a,p2_b,p2_c, p3_a,p3_b,p3_c, p4_a,p4_b,p4_c, p5_a,p5_b,p5_c, p6_a,p6_b,p6_c, p7_a,p7_b,p7_c, p8_a,p8_b,p8_c, p9_a,p9_b,p9_c, p10_a,p10_b,p10_c] = fit_Gaussian_model_nonasomy_2(workingDir, saveName, data,locations,init_width,func_type)
	...
	initial = [p1_ai,p1_ci,p2_ai,p2_ci,p3_ai,p3_ci,p4_ai,p4_ci,p5_ai,p5_ci,p6_ai,p6_ci,p7_ai,p7_ci,p8_ai,p8_ci,p9_ai,p9_ci,p10_ai,p10_ci];
...
function sse = fiterror(params,time,data,func_type,locations,show)
	...
	p10_fit = p10_a*exp(-0.5*((time-p10_b)./p10_c).^2);
