...
with open(logName, "a") as myfile:
	myfile.write("\t\t*======================================================================================*\n")
	myfile.write("\t\t| Log of 'scripts_seqModules/scripts_ddRADseq/putative_SNPs_from_parent_in_child.3.py' |\n")
	myfile.write("\t\t*--------------------------------------------------------------------------------------*\n")
...
for line_P in data_P:
	if (len(line_P) > 0):
		if (line_P[0] != "#"):
			...
			parent_SNPs.append([P_chrName,P_position]);
			old_P_chrID = P_chrID;
data_P.close();
