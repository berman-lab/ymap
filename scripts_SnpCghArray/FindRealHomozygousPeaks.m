function [realHomozygous_peak, disomy_fit] = ...
    FindRealHomozygousPeaks(chrCopyNum,SNP_probeset_length,probeset1,dataset,chr_breaks,chr_size,show_unnassigned,DataTypeToUse)
...
if (no_usable_ploidies == 0) % disomics/tetrasomics were found, so we can determine homozygous peak location.
    ...
    [initialHomozygous_peak, disomy_fit] = ...
        FindRealHomozygousPeaks_initial(chrCopyNum,SNP_probeset_length,probeset1,dataset,chr_breaks,chr_size,show_unnassigned,DataTypeToUse);
    ...
    show_fitting = 0;
    [p1_a,p1_b,p1_c, p2_a,p2_b,p2_c, p3_a,p3_b,p3_c] = ...
        fit_Gaussian_model_disomy(smoothed_1a,disomy_peak_estimates,15,0,'cubic',show_fitting);
