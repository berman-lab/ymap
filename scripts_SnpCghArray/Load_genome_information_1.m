...
lines_analyzed       = 0;
fprintf(['\tgenome_details/centromere_locations.txt\n']);
...
lines_analyzed = 0;
fprintf(['\tgenome_details/chromosome_sizes.txt\n']);
...
lines_analyzed    = 0;
annotations_count = 0;
fprintf(['\tgenome_details/annotations.txt\n']);
...
lines_analyzed         = 0;
fprintf(['\tgenomeDetails/figure_definitions.txt\n']);
