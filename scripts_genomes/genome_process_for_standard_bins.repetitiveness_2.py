...
with open(logName, "a") as myfile:
	myfile.write("\t\t\t*================================================================*\n");
	myfile.write("\t\t\t| Log of 'genome_process_for_standard_bins.repetitiveness_2.py'  |\n");
	myfile.write("\t\t\t*----------------------------------------------------------------*\n");
...
standardBins_FASTA_file = workingDir + fragmentedGenome;
...
with open(logName, "a") as myfile:
	...
	myfile.write("\n\t\t* 'py/genome_process_for_standard_bins.repetitiveness_2.py' completed. *\n")
