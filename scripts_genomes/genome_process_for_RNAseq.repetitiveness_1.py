...
#
# Process genome repetitiveness file by RNAseq-fragment definitions.
#	1) Ca_a_repetitiveness.txt							(links_dir/main_script_dir/repetitiveness_files/)
#	2) C_albicans_SC5314_version_A21-s02-m03-r03_chromosomes.expression.fasta	(links_dir/main_script_dir/blastdbs/)
# Output fragment repetitiveness data.
#	1) Ca_a_repetitiveness.expression.txt						(links_dir/main_script_dir/repetitiveness_files/)
#
...
with open(logName, "a") as myfile:
	myfile.write("\t\t\t*================================================================*\n")
	myfile.write("\t\t\t| Log of 'genome_process_for_RNAseq.repetitiveness_1.py'         |\n")
	myfile.write("\t\t\t*----------------------------------------------------------------*\n")


#============================================================================================================
# Process RNAseq-digested genome file.
#------------------------------------------------------------------------------------------------------------
...
RNAseq_FASTA_file = workingDir + string.replace(refFASTA, '.fasta','.expression.fasta')
RNAseq_FASTA_data = open(RNAseq_FASTA_file,'r')

with open(logName, "a") as myfile:
	myfile.write("\n\t\t\tDigested reference FASTA : " + RNAseq_FASTA_file)
...
with open(logName, "a") as myfile:
	myfile.write("\n\t\t\tProcessing RNAseq-digested genome file -> fragment coordinates.")
...
#------------------------------------------------------------------------------------------------------------
# End of code section to parse RNAseq fragments from genome.
#============================================================================================================

print "### ", time.clock() - t0, "seconds to parse RNAseq fragments from digested genome."
t1 = time.clock()
...
# InputFile = /heap/hapmap/bermanlab/users/darren/genomes/Candida_albicans_SC5314_verA21-s02-m09-r07/C_albicans_SC5314_version_A21-s02-m09-r07_chromosomes.repetitiveness.txt
#............................................................................................................
...
for line in data:
	...
	if line[1] == "#":
		...
		# Attempt to match up current data line with pre-determined RNAseq fragments.
		found = 0
...
#============================================================================================================
# Code section to output information about genome RNAseq fragments.
#------------------------------------------------------------------------------------------------------------
with open(logName, "a") as myfile:
	myfile.write("\n\t\t\tOutputting repetitiveness data of RNAseq fragment genome.")
...
print "### ", time.clock() - t2, "seconds to output basic stats of each RNAseq fragment."
