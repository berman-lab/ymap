function results = genome_process_for_RADseq_1_MfeI_MboI(user,genome)
...
if (exist([workingDir FastaName '.MfeI_MboI.fasta'],'file') == 0)
    %% ====================================================================
	...
	outputFile = [workingDir FastaName '.MfeI_MboI.fasta'];
