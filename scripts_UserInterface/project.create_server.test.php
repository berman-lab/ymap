<?php
	...
	mkdir($dir2);
	chmod($dir2,0777);
//	header('Location: '../project.create.test.php');  //send browser back to main page.
...
el1.innerHTML += "<?php echo $_SESSION['pending_install_project_count']; ?>. <?php echo $name; ?><br>";

var el2 = parent.document.getElementById('panel_manageDataset_iframe').contentDocument.getElementById('pending_comment');
el2.style.visibility = 'visible';

var el3 = parent.document.getElementById('Hidden_InstallNewDataset');
