        ...
        options: {
            ...
            add: function (e, data) {
                ...
                data.process(function () {
					...
					$('#info-wrapper-1').fadeIn('fast');
					$('#info-wrapper-2').fadeIn('fast');
					$('#info-wrapper-3').fadeIn('fast');
        ...
        _cancelHandler: function (e) {
            ...
            template.slideUp('fast', function () {
                if (data.jqXHR) {
					...
					$('#info-wrapper-1').fadeOut('fast');
					$('#info-wrapper-2').fadeOut('fast');
					$('#info-wrapper-3').fadeOut('fast');
