function [newX, newY1, newY2, newY3] = optimize_mylowess_2gaussian(rawData_X,rawData_Y,numFits, maxYforGaussian)
...
newX = X_range;
[newY1,newY2,newY3] = mylowess_2gaussian([X,Y],X_range,span, maxYforGaussian);
