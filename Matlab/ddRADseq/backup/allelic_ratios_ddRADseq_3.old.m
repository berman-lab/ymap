...
%		plot(dataX, dataY,'Color',[1.0 0.0 0.0],'Marker','.','MarkerSize',2);
%		dataX                         = P_chr_SNP_data_positions{    chr}/bases_per_bin;
%		dataY                         = maxY - P_chr_SNP_data_ratios{chr}*maxY;
%		plot(dataX, dataY,'Color',[1/3 1/3 1/3],'Marker','.','MarkerSize',2);
...
%			dataX                         = C_chr_SNP_data_positions{chr}/bases_per_bin;
%			dataY                         = C_chr_SNP_data_ratios{   chr}*maxY;
%			plot(dataX, dataY,'Color',[1.0 0.0 0.0]);
%			dataX                         = P_chr_SNP_data_positions{chr}/bases_per_bin;
%			dataY                         = P_chr_SNP_data_ratios{   chr}*maxY;
%			plot(dataX, maxY-dataY,'Color',[1/3 1/3 1/3]);
