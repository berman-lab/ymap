function [p1_a,p1_b,p1_c, p2_a,p2_b,p2_c, p3_a,p3_b,p3_c, p4_a,p4_b,p4_c, p5_a,p5_b,p5_c, skew_factor] ...
    = fit_Gaussian_model_tetrasomy_2(data,locations,init_width,fraction,skew_factor,func_type,show)
...
%[G1_a, G1_b, G1_c, G2_a, G2_b, G2_c, S_a, S_c] = GaussianModel_G1SG2(tet_control,parameter,'fcs1','');
    ...
    %initial = [p1_ai,p1_bi,p1_ci, p2_ai,p2_bi,p2_ci, p3_ai,p3_bi,p3_ci, p4_ai,p4_bi,p4_ci, p5_ai,p5_bi,p5_ci];
    initial = [p1_ai,p1_ci,p2_ai,p3_ai,p4_ai,p5_ai, skew_factor];
...
function sse = fiterror(params,time,data,func_type,locations,show,fraction)
    ...
    if (p3_c < 2*(1-fraction));   p3_c = 2*(1-fraction);   end;
