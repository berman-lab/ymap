function [] = CNV_v6_3(projectName,genome,ploidyString,ploidyBaseString, ...
...
if (exist([workingDir 'matlab_dir/' projectName '.CNV_' CNV_verString '.ploidy_' ploidyString '.mat'],'file') == 0) || ...
    ...
    save([workingDir 'matlab_dir/' projectName '.CNV_' CNV_verString '.ploidy_' ploidyString '.mat'],'chr_CNVdata');
    if (analyze_rDNA == 1)
...
genome_CNV = genome;
save([workingDir 'matlab_dir/' projectName '.common_CNV.mat'], 'CNVplot2','genome_CNV');
