function [] = analyze_SNPs_RNAseq(main_dir, user, genomeUser, project, parent, hapmap, genome, ploidyEstimateString,ploidyBaseString)
...
LOH_hapmap_v3_RNAseq(main_dir,user,genomeUser,project,hapmap,genome,ploidyEstimateString,ploidyBaseString, ...
                       SNP_verString,LOH_verString,CNV_verString,displayBREAKS);

% Alternate presentation of SNP data, showing allelic ratios of all data.
allelic_ratios_RNAseq_2(main_dir,user,genomeUser,project,parent,hapmap,genome,ploidyEstimateString,ploidyBaseString, ...
                         SNP_verString,LOH_verString,CNV_verString,displayBREAKS);

% Alternate presentation of SNP data, showing allelic ratios of all data.
allelic_ratios_RNAseq_3(main_dir,user,genomeUser,project,parent,hapmap,genome,ploidyEstimateString,ploidyBaseString, ...
                          SNP_verString,LOH_verString,CNV_verString,displayBREAKS);
