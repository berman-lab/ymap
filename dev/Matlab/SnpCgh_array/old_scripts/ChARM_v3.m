function [] = ChARM_v3(projectName, workingDir,figureDir)
%% =========================================================================================
...
%		set(gca,'YTickLabel',{'','',''});
%	    end;
%	    saveas(fig,[figureDir projectName '.ChARM_test.5.' num2str(chr_fig) '_' num2str(t,'%02d') '.eps'], 'epsc');
%	    delete(fig)
%	end;
    end;
end;
...
%--------------------------------------------------------------------------   
dataFile = [workingDir 'matlab_dir/' projectName '.common_ChARM.mat'];
