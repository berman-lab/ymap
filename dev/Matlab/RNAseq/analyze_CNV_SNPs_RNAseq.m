function [] = analyze_CNV_SNPs_RNAseq(main_dir, user, genomeUser, project, parent, hapmap, genome, ploidyEstimateString,ploidyBaseString)
...
fprintf('\n');
fprintf(['[analyze_CNV_SNPs_RNAseq.m data inputs:\n']);
...
%	CNV_SNP_hapmap_v3_RNAseq(main_dir,user,genomeUser,project,hapmap,genome,ploidyEstimateString,ploidyBaseString, ...
%	                         SNP_verString,LOH_verString,CNV_verString,displayBREAKS);

%	CNV_SNP_hapmap_v4_RNAseq(main_dir,user,genomeUser,project,parent,hapmap,genome,ploidyEstimateString,ploidyBaseString, ...
%	                         SNP_verString,LOH_verString,CNV_verString,displayBREAKS);

CNV_SNP_hapmap_v5_RNAseq(main_dir,user,genomeUser,project,parent,hapmap,genome,ploidyEstimateString,ploidyBaseString, ...
                         SNP_verString,LOH_verString,CNV_verString,displayBREAKS);

fprintf('*--- End of ''analyze_CNV_SNPs_RNAseq.m'' was reached ---*\n');
