function [p1_a,p1_b,p1_c, p2_a,p2_b,p2_c, p3_a,p3_b,p3_c, p4_a,p4_b,p4_c, p5_a,p5_b,p5_c, p6_a,p6_b,p6_c, p7_a,p7_b,p7_c, p8_a,p8_b,p8_c,skew_factor] = ...
    fit_Gaussian_model_heptasomy_2(data,locations,init_width,func_type)
    ...
    skew_factor1 = abs(Estimates(10));
	skew_factor2 = abs(Estimates(11));
	skew_factor3 = abs(Estimates(12));
	skew_factor4 = abs(Estimates(13));
	skew_factor5 = abs(Estimates(14));
	skew_factor6 = abs(Estimates(15));
	skew_factor7 = abs(Estimates(16));
	skew_factor8 = abs(Estimates(17));
