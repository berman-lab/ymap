...
#n/bash -e
#
# genome.install_6.plus_RNAseq.sh
#
set -e;
...
##
##
## This version of the genome processing sub-pipeline includes RNAseq analysis.
##
##
...
if [ -e $outputFile ]
then
	echo "\n\tSimplified and sorted chromosome_features file has been generated." >> $logName
else
