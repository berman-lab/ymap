...
onload=function(){
	...
	top.frames['<?php echo $key ?>'].frames[0].frames[0].label             = "Ref FASTQ (1/2)...";
	top.frames['<?php echo $key ?>'].frames[0].frames[0].target_dir        = "<?php echo $directory."users/".$user."/projects/".$project."/"; ?>";
	top.frames['<?php echo $key ?>'].frames[0].frames[0].conclusion_script = "<?php echo $url."php/ddRADseq_4.install_3.php";                 ?>";
	top.frames['<?php echo $key ?>'].frames[0].frames[0].user              = "<?php echo $user;                                               ?>";
	top.frames['<?php echo $key ?>'].frames[0].frames[0].project           = "<?php echo $project;                                            ?>";
	top.frames['<?php echo $key ?>'].frames[0].frames[0].key               = "<?php echo $key;                                                ?>";
}
</script>
