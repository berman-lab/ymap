...
<html lang="en">
	...
	<BODY onload="UpdateNextList()">
		<div id="loginControls"><p>
			...
			<button type="button" onclick="window.location.href='<?php if(isset($_SESSION['logged_on'])){echo "logout_server.php";}else{echo "login.php";}?>'"><?php if(isset($_SESSION['logged_on'])){echo "Logout";}else{echo "Login";}?></button>
