...
// Initialize log file.
	...
	fwrite($logOutput, "#..............................................................................\n");
	fwrite($logOutput, "Running 'php/project.single_RNAseq.install_2.php'.\n");
	fwrite($logOutput, "Variables passed via command-line from 'php/project.single_RNAseq.install_1.php' :\n");
...
// Identify format of uploaded file and decompress as needed (*.ZIP; *.GZ).
	...
	foreach ($fileNames as $key=>$name) {
		...
		if (strcmp($ext,"zip") == 0) {
			...
			// add file name to 'datafiles.txt'.
			fwrite($output, $newName."\n");
		} else if ((strcmp($ext,"fastq") == 0) || (strcmp($ext,"fa") == 0)) {
    ...
    if ($paired == 1) {
		...
		$system_call_string = "sh ".$directory."sh/project.paired_RNAseq.install_3.sh ".$user." ".$project." ".$directory." > /dev/null &";
	} else {
		...
		fwrite($logOutput, "Current directory = '".getcwd()."'\n" );
		$system_call_string = "sh ".$directory."sh/project.single_RNAseq.install_3.sh ".$user." ".$project." ".$directory." > /dev/null &";
	}
