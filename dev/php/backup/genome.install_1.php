...
?>
<BODY onload = "parent.resize_iframe('<?php echo $key; ?>', <?php echo ($chr_count + 12.5)*26; ?>);" >

<font color="red">Fill in genome details:</font>
	<form action="genome.install_2.php" method="post">
		<table border="0">
		<tr>
			<th rowspan="2">Use</th>
			<th rowspan="2">FASTA entry name</th>
			<th rowspan="2">Short</th>
			<th colspan="2">Centromere</th>
			<th rowspan="2">rDNA</th>
		</tr>
		<tr>
			<th>start bp</th>
			<th>end bp</th>
...
<?php
		...
		How many (non rDNA) annotations would you like to add to this genome? <input type="text" name="annotation_count" value="0" size="6"><br>
		<br>
