...
### Inputfile1 & Inputfile2 are 'putative_SNPs_v4.txt' files for the two strains.
###
...
# inputFile1  = main_dir+"users/"+project1User+"/projects/"+project1+"/putative_SNPs_v4.txt"
...
# Open dataset 'putative_SNPs_v4.txt' file.
...
print '### Data lines for each het locus in parent : [chromosome_name, bp_coordinate, project1_ratio, project2_ratio]'

with open(logName, "a") as myfile:
	myfile.write("|\t2")

# Process 'putative_SNPs_v4.txt' file for both parents, line by line... while checking for missing data.
