...
#	1) Ca_a_repetitiveness.txt
#	2) [reference_genome_FASTA_name].standard_bins.fasta
# Output fragment repetitiveness data.
#	1) Ca_a_repetitiveness.standard_bins.txt
#
...
with open(logName, "a") as myfile:
	myfile.write("\n\t\t-----------------------------------------------------------")
	myfile.write("\n\t\tLog of genome_process_for_standard_bins.repetitiveness_1.py")
	myfile.write("\n\t\t-----------------------------------------------------------")
...
with open(logName, "a") as myfile:
	myfile.write("\n\t\t\tProcessing standard binfragmented genome file -> fragment coordinates.")
