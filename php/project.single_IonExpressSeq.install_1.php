...
//$fileName = "ca21_TWTC1_ACACGATC.indelRealigned.bam";
//$user     = "darren";
//$project  = "CFord_1";
//$key      = "p_0";
...
// Initialize log file.
	...
	fwrite($logOutput, "#..............................................................................\n");
	fwrite($logOutput, "Running 'php/project.single_IonExpressSeq.install_1.php'.\n");
...
// Installation continues with next php script... strings recieved as POST are forwarded to next script.
	fwrite($logOutput, "Passing control to : 'php/project.single_IonExpressSeq.install_2.php'\n");
 	$system_call_string = "php project.single_IonExpressSeq.install_2.php ".$fileName." ".$user." ".$project." > /dev/null &";
