...
// Initialize log file.
	...
	fwrite($logOutput, "#..............................................................................\n");
	fwrite($logOutput, "Running 'php/project.paired_ddRADseq.install_1.php'.\n");
...
// Installation continues with next php script... strings recieved as POST are forwarded to next script.
	fwrite($logOutput, "Passing control to : 'php/project.paired_ddRADseq.install_2.php'\n");
 	$system_call_string = "php project.paired_ddRADseq.install_2.php ".$fileName." ".$user." ".$project." ".$directory." > /dev/null &";
