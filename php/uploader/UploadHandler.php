...
/*
 * Downloaded from : https://github.com/blueimp/jQuery-File-Upload
 * on date : 02-15-2023
 *
 * Several changes were made to use with Ymap, lines are commented with [**].
 *
 */
...
{   protected $options;
    ...
    public function __construct($target, $options = null, $initialize = true, $error_messages = null) { // [**]: Add $target to input.
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            // 'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            'upload_dir' => $target,    // [**]: tie $target received from call into processing.
            ...
            'accept_file_types' => '/\.(csv|txt|fasta|fastq|zip|gz|sam|bam)$/i', // [**]: defines ymap input file types.
