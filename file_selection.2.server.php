<?php
	...
	$file2_key         = filter_input(INPUT_POST, "File_selection_2", FILTER_SANITIZE_STRING);
...
<script type="text/javascript">
	onload=function() {
		...
		input4.setAttribute("value","<?php echo $FTPdrop_file1.",".$FTPdrop_file2; ?>");
