...
<html lang="en">
	...
	<BODY onload="UpdateHapmapList(); UpdateParentList()">
		<div id="loginControls"><p>
			...
			<button type="button" onclick="window.location.href='<?php if(isset($_SESSION['logged_on'])){echo "php/logout_server.php";}else{echo "login.php";}?>'">
		...
		<div id="projectCreationInformation"><p>
			<form action="php/project.create_server.php" method="post">
				<table><tr bgcolor="#CCFFCC"><td>
					...
					<?php
					$genomesDir1       = $GLOBALS['directory']."users/default/genomes/";
					$genomesDir2       = $GLOBALS['directory']."users/".$user."/genomes/";
